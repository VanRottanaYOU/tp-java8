...
//        Map<Customer, List<Order>> result = orders.stream().collect(Collectors.groupingBy(order -> order.getCustomer(), Collectors.toList()));
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted((c1,c2)->c1.getFirstname().compareTo(c2.getFirstname()))
        		.collect(Collectors.groupingBy(Customer::getGender,
        		Collectors.mapping(Customer::getFirstname,
        		Collectors.joining("|"))));     
        		;
